...
function CourseDetails() {
  ...
  // whenever User click on a course_card the Url changes -> courseId value also changes -> useEffect() triggered
  useEffect(() => {
    ;(async () => {
      try {
  ...
  // 1- Calculating Avg Review count
  ...
  // 2- Total number of lectures SUb-section / Video
  ...
  const handleActive = (id) => {
    ...
    setIsActive( !isActive.includes(id) ? isActive.concat([id]) : isActive.filter((e) => e !== id)) // toggle

  }

  // Validation 1 - if loading is true or courseData is null
  if (loading || !courseData) {
   ...
   // Validation 2 - if courseData.success = "false"
  if (!courseData.success) {
    return <Error />
  }

  // Validation 3 - if paymentLoading = "true"
  if (paymentLoading) {
    return (
      <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
        <div className="spinner"></div>
  ...
  // Store required courseData from Backend response
  const {
    _id: course_id,
    courseName,
    courseDescription,
  ...
  // Buy Course Button and MODAL/ POPUP
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className={`z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5`}>
              ...
              <div className="text-md flex flex-wrap items-center gap-2">
                <span className="text-yellow-25">{avgReviewCount}</span><RatingStars Review_Count={avgReviewCount} Star_Size={24} />
          ...
          <div className="max-w-[830px] ">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap justify-between gap-2">
                ...
                <div>
                {/* COLLAPSE BUTTON -> empty the array to close all section and subsections */}
